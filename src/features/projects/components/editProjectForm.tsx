...
export const EditProjectForm = ({
  ...
  const currentManager = members?.find(
    (member) => member.id === initialValues.projectManagerId
  );
        ...
        <CardContent className="p-7">
          {!hasProjectManager && (
            <Alert className="mb-4">
              ...
              <AlertDescription>
                No Project Manager assigned. Tasks may only award points when a
                Project Manager is assigned to manage the store system.
              </AlertDescription>
            </Alert>
          )}
          ...
          <div className="flex flex-col gap-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-2">
                The Project Manager can manage store items and approve
                redemption requests.
              </p>
            </div>
            ...
            <Select
              ...
              onValueChange={(value) =>
                handleProjectManagerChange(value === "none" ? null : value)
              }
